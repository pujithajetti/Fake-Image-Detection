#!/usr/bin/env python3
"""
Safe VGG19 Training Script - macOS Threading Safe
"""
...
try:
    ...
    from config import VGG19_MODEL_PATH
    ...
    print("✅ VGG19 base model loaded and configured")
    ...
    print(f"✅ VGG19 training completed!")
    print(f"📊 Test Accuracy: {test_accuracy:.4f} ({test_accuracy*100:.2f}%)")
    print(f"📊 Test Loss: {test_loss:.4f}")
    
    # Save model
    model.save(VGG19_MODEL_PATH)
    print(f"💾 Model saved to: {VGG19_MODEL_PATH}")
    
    # Plot training history
    plot_history(history, "VGG19")
    
    print("🎉 VGG19 training completed successfully!")
    
except Exception as e:
    print(f"❌ VGG19 training failed: {str(e)}")
    sys.exit(1)
